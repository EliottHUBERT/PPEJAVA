...
public class MyDefaultTableModelAllRDV extends DefaultTableModel {
	...
	public MyDefaultTableModelAllRDV(List<Rendezvous> Rendezvous) {
		super();
	...
	public Object getValueAt(int row, int column) {
		...
		switch (column) {
			...
			case 3:
				...
				break;
			case 4:
				value = rdv.getUser().getId() + " | " + rdv.getUser().getLogin();
				break;
			case 5:
